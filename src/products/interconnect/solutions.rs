...
impl StandardErrorSolutionsTrait for TwilioInterconnectError {
    fn solutions(&self) -> Option<&'static str> {
        match self {
            ...
            TwilioInterconnectError::ErrorCode62200 => Some(r#"check the status of the NSO if the network is fine."#),
            ...
            TwilioInterconnectError::ErrorCode62100 => Some(r#"New valid IP address"#),
            ...
            TwilioInterconnectError::ErrorCode62220 => Some(r#"Upgrade the capacity on the network device."#)
        }
    }
}
